...
```typescript
// Creating a custom knowledge base implementation
...
```typescript
// With ACL for identity-aware retrieval
const kb = new BedrockKnowledgeBase(this, 'TeamDocs', {
  name: 'team-documentation',
  description: 'Team-specific documentation with access control',
  knowledgeBaseId: 'IJKL9012',
  acl: {
    enabled: true,
    metadataField: 'team',
  },
...
```typescript
const kb = new BedrockKnowledgeBase(this, 'ProductDocs', {
...
```typescript
const kbProps: BedrockKnowledgeBaseProps = {
  name: 'product-docs',
  description: 'Product documentation and FAQs',
  knowledgeBaseId: 'ABCD1234',
  retrieval: {
...
```typescript
// Using the default BedrockKnowledgeBase implementation
...
```typescript
// Example return value for Bedrock KB
[
  new PolicyStatement({
    effect: Effect.ALLOW,
    actions: ['bedrock:Retrieve', 'bedrock:RetrieveAndGenerate'],
    resources: ['arn:aws:bedrock:us-east-1:123456789012:knowledge-base/ABCD1234'],
  })
]
```
