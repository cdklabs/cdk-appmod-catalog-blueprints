...
describe('BaseDocumentProcessing CDK Nag', () => {
  test('passes CDK Nag checks with all configurations', () => {
    const stack = new Stack(undefined, 'BaseDocProcessingStack', {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      stack,
      '/BaseDocProcessingStack/BucketNotificationsHandler050a0587b7544547bf325f094a3db834/Role',
      [
        {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      stack,
      '/BaseDocProcessingStack/BaseDocumentProcessing/StateMachineRole/DefaultPolicy',
      [
        {
          id: 'AwsSolutions-IAM5',
