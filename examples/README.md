...
| **[AgentCore Document Processing](./document-processing/agentcore-document-processing/)** | Document Processing | Insurance claims processing with Lambda and AgentCore runtimes comparison | Long-running document processing, runtime flexibility, production deployments |
