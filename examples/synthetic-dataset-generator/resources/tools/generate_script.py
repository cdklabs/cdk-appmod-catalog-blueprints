...
# This allows us to push events (tool_start) directly into the SSE stream.
try:
...
def generate_script(
    ...
    """
    # Emit tool_start event to trigger frontend loading spinners
    emit_sse_event('tool_start', {'tool': 'generate_script'})
